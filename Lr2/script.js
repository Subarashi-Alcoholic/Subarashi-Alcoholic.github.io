window.onload = function(){ 
    ...
    changeColorButton = document.getElementById("btn_swap_bgcolor"); //смена цвета фона
    ...
    changeColorButton = document.getElementById("btn_swap_rescolor"); //смена цвета окна
    changeColorButton.onclick = function() {
        const randomColor = getRandomColor();
